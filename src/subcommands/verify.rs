...
impl TryFrom<&Verify> for NativeOperation {
    type Error = ParsecToolError;

    fn try_from(psa_generate_key_subcommand: &Verify) -> Result<NativeOperation, Self::Error> {
...
impl ParsecToolSubcommand<'_> for Verify {
    /// Exports a key.
